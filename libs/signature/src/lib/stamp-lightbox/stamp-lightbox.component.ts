...
@Component({
  ...
  templateUrl: './stamp-lightbox.component.html',
  styleUrls: ['./stamp-lightbox.component.less']
})
export class StampLightboxComponent implements OnInit, OnDestroy {
  ...
  getWidth() {
    return this.isMobile ? this._windowService.getWidth() : 1079;
  }

  getHeight() {
    return this.isMobile ? this._windowService.getHeight() : 540;
  }
}
