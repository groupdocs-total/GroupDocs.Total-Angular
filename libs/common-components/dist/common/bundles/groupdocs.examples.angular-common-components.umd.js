(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('jquery'), require('angular2-fontawesome/angular2-fontawesome'), require('@angular/common/http'), require('rxjs'), require('@angular/platform-browser'), require('rxjs/operators')) :
    typeof define === 'function' && define.amd ? define('@groupdocs.examples.angular/common-components', ['exports', '@angular/core', '@angular/common', 'jquery', 'angular2-fontawesome/angular2-fontawesome', '@angular/common/http', 'rxjs', '@angular/platform-browser', 'rxjs/operators'], factory) :
    (global = global || self, factory((global.groupdocs = global.groupdocs || {}, global.groupdocs.examples = global.groupdocs.examples || {}, global.groupdocs.examples.angular = global.groupdocs.examples.angular || {}, global.groupdocs.examples.angular['common-components'] = {}), global.ng.core, global.ng.common, global.jquery, global.angular2Fontawesome, global.ng.common.http, global.rxjs, global.ng.platformBrowser, global.rxjs.operators));
}(this, function (exports, core, common, jquery, angular2Fontawesome, http, rxjs, platformBrowser, operators) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var ViewportService = /** @class */ (function () {
        ...
        ViewportService.ngInjectableDef = core.defineInjectable({ factory: function ViewportService_Factory() { return new ViewportService(); }, token: ViewportService, providedIn: "root" });
    ...
    var ModalComponent = /** @class */ (function () {
        ...
        ModalComponent = __decorate([
            ...
            __metadata("design:paramtypes", [ModalService, core.ElementRef])
        ], ModalComponent);
    ...
    var UploadFilesService = /** @class */ (function () {
        function UploadFilesService() {
            var _this = this;
            this._uploadsChange = new rxjs.Observable(function (observer) {
    ...
    var BrowseFilesModalComponent = /** @class */ (function () {
        function BrowseFilesModalComponent(_uploadService) {
            ...
            this.сlose = new core.EventEmitter();
    ...
    var SanitizeResourceHtmlPipe = /** @class */ (function () {
        ...
        SanitizeResourceHtmlPipe = __decorate([
            core.Pipe({ name: 'safeResourceHtml' }),
            __metadata("design:paramtypes", [platformBrowser.DomSanitizer])
    ...
    var PagePreloadService = /** @class */ (function () {
        function PagePreloadService() {
            var _this = this;
            this._checkPreload = new rxjs.Observable(function (observer) {
                return _this._observer = observer;
            });
        }
    ...
    var NavigateService = /** @class */ (function () {
        function NavigateService(_pagePreloadService) {
            ...
            this._currentPage = 0;
            this._countPages = 0;
            this._navigate = new rxjs.Observable(function (observer) {
                return _this._observer = observer;
            });
        }
        ...
        NavigateService.ngInjectableDef = core.defineInjectable({ factory: function NavigateService_Factory() { return new NavigateService(core.inject(PagePreloadService)); }, token: NavigateService, providedIn: "root" });
    ...
    var WindowService = /** @class */ (function () {
        function WindowService() {
            ...
            this._resize$ = rxjs.fromEvent(window, 'resize')
                .pipe(operators.debounceTime(200), operators.distinctUntilChanged(), operators.startWith({ target: { innerWidth: window.innerWidth, innerHeight: window.innerHeight } }), operators.tap(function (event) {
    ...
    var ZoomDirective = /** @class */ (function () {
        ...
        __decorate([
            core.HostBinding('style.-moz-transform'),
            __metadata("design:type", String)
        ], ZoomDirective.prototype, "mozTransform", void 0);
        __decorate([
            core.HostBinding('style.-moz-transform-origin'),
            __metadata("design:type", String)
        ], ZoomDirective.prototype, "mozTransformOrigin", void 0);
        __decorate([
            core.HostBinding('style.-webkit-transform'),
            __metadata("design:type", Object)
        ], ZoomDirective.prototype, "webkitTransform", void 0);
        __decorate([
            core.HostBinding('style.-ms-transform'),
            __metadata("design:type", Object)
        ], ZoomDirective.prototype, "msTransform", void 0);
        __decorate([
            core.HostBinding('style.-o-transform'),
            __metadata("design:type", Object)
        ...
        ZoomDirective = __decorate([
            ...
            __metadata("design:paramtypes", [ZoomService, platformBrowser.DomSanitizer])
        ], ZoomDirective);
    ...
    var OnCloseService = /** @class */ (function () {
        ...
        OnCloseService.ngInjectableDef = core.defineInjectable({ factory: function OnCloseService_Factory() { return new OnCloseService(); }, token: OnCloseService, providedIn: "root" });
    ...
    var RotationDirective = /** @class */ (function () {
        ...
        __decorate([
            core.HostBinding('style.animation'),
            __metadata("design:type", String)
        ], RotationDirective.prototype, "animation", void 0);
        __decorate([
            core.HostBinding('style.transition-property'),
            __metadata("design:type", String)
    ...
    var RenderPrintService = /** @class */ (function () {
        function RenderPrintService() {
            var _this = this;
            this._render = new rxjs.Observable(function (observer) {
                return _this._observer = observer;
            });
            this._renderBlob = new rxjs.Observable(function (observer) {
    ...
    var ErrorInterceptorService = /** @class */ (function () {
        ...
        ErrorInterceptorService.prototype.intercept = function (req, next) {
            ...
            return next.handle(req)
                ...
                return data;
            }), operators.catchError(function (exception) {
        ...
        ErrorInterceptorService.ngInjectableDef = core.defineInjectable({ factory: function ErrorInterceptorService_Factory() { return new ErrorInterceptorService(core.inject(ModalService), core.inject(ExceptionMessageService)); }, token: ErrorInterceptorService, providedIn: "root" });
    ...
    var BackFormattingService = /** @class */ (function (_super) {
        ...
        BackFormattingService.ngInjectableDef = core.defineInjectable({ factory: function BackFormattingService_Factory() { return new BackFormattingService(); }, token: BackFormattingService, providedIn: "root" });
    ...
    var SelectionService = /** @class */ (function () {
        ...
        SelectionService.ngInjectableDef = core.defineInjectable({ factory: function SelectionService_Factory() { return new SelectionService(); }, token: SelectionService, providedIn: "root" });
    ...
    var EditHtmlService = /** @class */ (function () {
        ...
        EditHtmlService.ngInjectableDef = core.defineInjectable({ factory: function EditHtmlService_Factory() { return new EditHtmlService(); }, token: EditHtmlService, providedIn: "root" });
    ...
    var CommonComponentsModule = /** @class */ (function () {
        ...
        CommonComponentsModule = CommonComponentsModule_1 = __decorate([
            core.NgModule({
                imports: [common.CommonModule, angular2Fontawesome.Angular2FontawesomeModule],
                declarations: [
                    TopToolbarComponent,
                    ButtonComponent,
                    LogoComponent,
    ...
    exports.ɵa = TabbedToolbarsComponent;
    exports.ɵb = TabComponent;
    exports.ɵc = TabsComponent;
    exports.ɵd = ColorPickerComponent;
    exports.ɵe = FormattingDirective;
    exports.ɵf = SuccessModalComponent;
    exports.ɵg = EditorDirective;
