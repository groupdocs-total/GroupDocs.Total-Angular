...
class UploadFilesService {
    constructor() {
        this._uploadsChange = new rxjs__WEBPACK_IMPORTED_MODULE_7__["Observable"]((/**
         * @param {?} observer
         * @return {?}
         */
 ...
 */
/** @type {?} */
const $ = jquery__WEBPACK_IMPORTED_MODULE_8__;
/** @type {?} */
...
class ZoomService {
    constructor() {
        this._observer = new rxjs__WEBPACK_IMPORTED_MODULE_7__["Subject"]();
...
class WindowService {
    constructor() {
        this.resizeSubject = new rxjs__WEBPACK_IMPORTED_MODULE_7__["Subject"]();
        this.width = window.innerWidth;
        this.height = window.innerHeight;
        this._resize$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_7__["fromEvent"])(window, 'resize')
 ...
 */
/** @type {?} */
const $$1 = jquery__WEBPACK_IMPORTED_MODULE_8__;
class DocumentComponent {
    ...
    ngAfterViewInit() {
        ...
        /** @type {?} */
        const hammer = new hammerjs__WEBPACK_IMPORTED_MODULE_9__(this.container);
    }
...
class PagePreloadService {
    constructor() {
        this._checkPreload = new rxjs__WEBPACK_IMPORTED_MODULE_7__["Observable"]((/**
         * @param {?} observer
         * @return {?}
         */
        observer => this._observer = observer));
...
class NavigateService {
    ...
    constructor(_pagePreloadService) {
        ...
        this._currentPage = 0;
        this._countPages = 0;
        this._navigate = new rxjs__WEBPACK_IMPORTED_MODULE_7__["Observable"]((/**
         * @param {?} observer
         * @return {?}
         */
        observer => this._observer = observer));
 ...
 */
/** @type {?} */
const $$2 = jquery__WEBPACK_IMPORTED_MODULE_8__;
 ...
 */
/** @type {?} */
const $$3 = jquery__WEBPACK_IMPORTED_MODULE_8__;
...
class RenderPrintService {
    constructor() {
        this._render = new rxjs__WEBPACK_IMPORTED_MODULE_7__["Observable"]((/**
         * @param {?} observer
         * @return {?}
         */
        observer => this._observer = observer));
        this._renderBlob = new rxjs__WEBPACK_IMPORTED_MODULE_7__["Observable"]((/**
         * @param {?} observer
         * @return {?}
         */
...
class ExceptionMessageService {
    constructor() {
        this._observer = new rxjs__WEBPACK_IMPORTED_MODULE_7__["BehaviorSubject"]('Server is not available');
...
class ErrorInterceptorService {
    ...
    intercept(req, next) {
        ...
        (exception) => {
            ...
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_7__["throwError"])(exception);
        })));
    }
}
...
class SearchService {
    constructor() {
        ...
        this._observerCurrent = new rxjs__WEBPACK_IMPORTED_MODULE_7__["Subject"]();
        this._currentChange = this._observerCurrent.asObservable();
        this._observerTotal = new rxjs__WEBPACK_IMPORTED_MODULE_7__["Subject"]();
 ...
 */
/** @type {?} */
const $$4 = jquery__WEBPACK_IMPORTED_MODULE_8__;
...
class FormattingService {
    constructor() {
        this._observerBold = new rxjs__WEBPACK_IMPORTED_MODULE_7__["Subject"]();
        this._formatBoldChange = this._observerBold.asObservable();
        this._observerUnderline = new rxjs__WEBPACK_IMPORTED_MODULE_7__["Subject"]();
        this._formatUnderlineChange = this._observerUnderline.asObservable();
        this._observerUndo = new rxjs__WEBPACK_IMPORTED_MODULE_7__["Subject"]();
        this._undo = this._observerUndo.asObservable();
        this._observerRedo = new rxjs__WEBPACK_IMPORTED_MODULE_7__["Subject"]();
        this._redo = this._observerRedo.asObservable();
        this._observerItalic = new rxjs__WEBPACK_IMPORTED_MODULE_7__["Subject"]();
        this._formatItalicChange = this._observerItalic.asObservable();
        this._observerColor = new rxjs__WEBPACK_IMPORTED_MODULE_7__["Subject"]();
        this._formatColorChange = this._observerColor.asObservable();
        this._observerBgColor = new rxjs__WEBPACK_IMPORTED_MODULE_7__["Subject"]();
        this._formatBgColorChange = this._observerBgColor.asObservable();
        this._observerFontSize = new rxjs__WEBPACK_IMPORTED_MODULE_7__["Subject"]();
        this._formatFontSizeChange = this._observerFontSize.asObservable();
        this._observerFont = new rxjs__WEBPACK_IMPORTED_MODULE_7__["Subject"]();
        this._formatFontChange = this._observerFont.asObservable();
        this._observerStrikeout = new rxjs__WEBPACK_IMPORTED_MODULE_7__["Subject"]();
        this._formatStrikeoutChange = this._observerStrikeout.asObservable();
        this._observerAlign = new rxjs__WEBPACK_IMPORTED_MODULE_7__["Subject"]();
        this._formatAlignChange = this._observerAlign.asObservable();
        this._observerList = new rxjs__WEBPACK_IMPORTED_MODULE_7__["Subject"]();
 ...
 */
/** @type {?} */
const $$5 = jquery__WEBPACK_IMPORTED_MODULE_8__;
 ...
 */
/** @type {?} */
const $$6 = jquery__WEBPACK_IMPORTED_MODULE_8__;
...
CommonComponentsModule.decorators = [
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"], args: [{
                imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _fortawesome_angular_fontawesome__WEBPACK_IMPORTED_MODULE_2__["FontAwesomeModule"], ng_click_outside__WEBPACK_IMPORTED_MODULE_12__["ClickOutsideModule"]],
                declarations: [
                    TopToolbarComponent,
                    SidePanelComponent,
                    ButtonComponent,
...
let ConversionAppComponent = class ConversionAppComponent {
        ...
        _conversionService.selectedItems.subscribe((selectedFormats) => {
            selectedFormats.forEach((selectedFormat) => {
                if (Object.keys(selectedFormat).length > 0 && !this.itemAlreadyAdded(selectedFormat)) {
                    this.conversionItems.push(selectedFormat);
                }
            });
        });
...
let ConversionBrowseFilesModalComponent = class ConversionBrowseFilesModalComponent extends _groupdocs_examples_angular_common_components__WEBPACK_IMPORTED_MODULE_2__["BrowseFilesModalComponent"] {
    constructor(_uploadService, _conversionService, _modalService) {
        super(_uploadService);
        this._conversionService = _conversionService;
        this._modalService = _modalService;
        this.selectAll = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        this.dynamicOptions = [];
    }
    selectDD(entry) {
            ...
            for (let i = 0; i < longestArray.length; i++) {
                ...
                if (typesArr.indexOf(type) === -1 && typesArr.filter(t => t.name === type).length === 0) {
                    longestArray[i] = {
                        ...
                        name: type,
                        warning: true,
                        icon: this.getFormatIcon({ name: 'dummyName.' + type, directory: false })
                    };
                }
                else {
        ...
        this.files.forEach((f) => {
            if (f.selected && !f.isDirectory && !f.directory) {
                ...
                const conversionItem = {
                    ...
                    destinationFormatName: this.getFormatName({ name: destinationFileName, directory: false }),
                    destinationIcon: this.getFormatIcon({ name: destinationFileName, directory: false }),
                    converted: false,
...
let ConversionConfigService = class ConversionConfigService {
    constructor(_http, _config) {
        this._http = _http;
        this._config = _config;
    ...
    load() {
        return new Promise((resolve, reject) => {
            const configEndpoint = this._config.getConfigEndpoint(_groupdocs_examples_angular_common_components__WEBPACK_IMPORTED_MODULE_3__["Api"].CONVERSION_APP);
            this._http.get(configEndpoint, _groupdocs_examples_angular_common_components__WEBPACK_IMPORTED_MODULE_3__["Api"].httpOptionsJson).toPromise().then((response) => {
...
let ConversionItemComponent = class ConversionItemComponent {
...
let ConversionQueueComponent = class ConversionQueueComponent {
    constructor() {
        this.items = [];
...
let ConversionModule = ConversionModule_1 = class ConversionModule {
    constructor() {
...
let ConversionService = class ConversionService {
    ...
    convert(file) {
        const req = new _models__WEBPACK_IMPORTED_MODULE_5__["ConversionRequestModel"]();
        req.added = true;
    ...
    constructor(_editorService, _modalService, configService, uploadFilesService, passwordService, _windowService, _formattingService, _backFormattingService, _onCloseService, _selectionService, _htmlService, _renderPrintService, _loadingMaskService) {
        ...
        uploadFilesService.uploadsChange.subscribe((uploads) => {
            if (uploads) {
                let i;
                for (i = 0; i < uploads.length; i++) {
                    this._editorService.upload(uploads.item(i), '', this.editorConfig.rewrite).subscribe((obj) => {
...
let DndSignatureDirective = class DndSignatureDirective extends _groupdocs_examples_angular_common_components__WEBPACK_IMPORTED_MODULE_2__["DndDirective"] {
    constructor(_uploadFilesService) {
...
let HandModalComponent = class HandModalComponent {
    ...
    saveSign(canvasComponent) {
        ...
        this._signatureService.saveImage(img).subscribe(() => {
            this._tabActivationService.changeActiveTab(_signature_models__WEBPACK_IMPORTED_MODULE_4__["SignatureType"].HAND.id);
        });
        this.close();
    }
    close() {
...
let NewBarQrCodeComponent = class NewBarQrCodeComponent {
    constructor(_signatureService, _elementRef) {
        ...
        this.subject.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["debounceTime"])(500)).subscribe(text => {
            this.saveCode(text, true);
        });
    }
    saveCode(text, temp) {
        if (text) {
            this._signatureService.getCode(text, temp, this.type).subscribe((data) => {
...
const $ = jquery__WEBPACK_IMPORTED_MODULE_10__;
let SignatureAppComponent = class SignatureAppComponent {
    constructor(_signatureService, _modalService, configService, uploadFilesService, _navigateService, _zoomService, pagePreloadService, _renderPrintService, passwordService, _windowService, _selectSignatureService, _signatureTabActivationService, _hostingComponentsService, _addDynamicComponentService, _dragSignatureService, _onCloseService, removeSignatureService, _activeSignatureService, _excMessageService, _signaturesHolderService, _tabActivatorService, copySignatureService) {
        ...
        this._tabActivatorService.activeTabChange.subscribe((tabId) => {
            if (tabId === '1') {
        ...
        copySignatureService.copySignature.subscribe((copySign) => {
            ...
            if (componentRef) {
                ...
                const sign = new _signature_models__WEBPACK_IMPORTED_MODULE_5__["DraggableSignature"]();
                sign.type = comp.signatureType;
                sign.guid = copySign.guid;
                sign.position = comp.position;
                const addedSignature = new _signature_models__WEBPACK_IMPORTED_MODULE_5__["AddedSignature"]();
        ...
        copySignatureService.changesSignature.subscribe((copyChanges) => {
        ...
        removeSignatureService.removeSignature.subscribe((del) => {
        ...
        uploadFilesService.uploadsChange.subscribe((uploads) => {
            if (uploads) {
                let i;
                for (i = 0; i < uploads.length; i++) {
                    this._signatureService.upload(uploads.item(i), '', this.rewriteConfig, null).subscribe((obj) => {
                        this.fileWasDropped ? this.selectFile(obj.guid, '', '') : this.selectDir('');
                    });
                }
            }
        ...
        _selectSignatureService.selectSignature.subscribe((sign) => {
    ...
    dropSignature($event) {
        $event.preventDefault();
        $event.stopPropagation();
        const position = _groupdocs_examples_angular_common_components__WEBPACK_IMPORTED_MODULE_3__["Utils"].getMousePosition($event);
        ...
        if (currentPage && $(currentPage).parent().parent() && $(currentPage).parent().parent().parent().hasClass("page")) {
            ...
            const currentPosition = new _signature_models__WEBPACK_IMPORTED_MODULE_5__["Position"](left, top);
    ...
    selectSignature(sign) {
        if (sign.type === _signature_models__WEBPACK_IMPORTED_MODULE_5__["SignatureType"].DIGITAL.id) {
            ...
            this._signatureService.loadSignatureImage(sign).subscribe((signature) => {
    ...
    addSignatureComponent(addedSignature, sign, page) {
        ...
        if (dynamicDirective) {
            ...
            const selectSignature = this._addDynamicComponentService.addDynamicComponent(viewContainerRef, _signature_signature_component__WEBPACK_IMPORTED_MODULE_7__["Signature"]);
    ...
    addTextSign() {
        const signature = new _signature_models__WEBPACK_IMPORTED_MODULE_5__["AddedSignature"]();
    ...
    sign() {
        ...
        this._signatureService.sign(this.credentials, signatures).subscribe((ret) => {
            this._modalService.open(_groupdocs_examples_angular_common_components__WEBPACK_IMPORTED_MODULE_3__["CommonModals"].OperationSuccess);
    ...
    isVisible(id) {
        const notCode = id !== _signature_models__WEBPACK_IMPORTED_MODULE_5__["SignatureType"].BAR_CODE.id && id !== _signature_models__WEBPACK_IMPORTED_MODULE_5__["SignatureType"].QR_CODE.id;
...
let SignatureLeftPanelComponent = class SignatureLeftPanelComponent {
    ...
    getSignatures(tabId) {
        this._signatureService.getSignatures('', tabId).subscribe((signatures) => {
    ...
    getTitle() {
        ...
        const signatureType = _signature_models__WEBPACK_IMPORTED_MODULE_2__["SignatureType"].getSignatureType(this.id);
...
let SignatureListPanelComponent = class SignatureListPanelComponent {
    ...
    getSign(guid) {
        const sign = new _signature_models__WEBPACK_IMPORTED_MODULE_2__["DraggableSignature"]();
...
FileListWithParams.ctorParameters = () => [
    { type: FileList },
    { type: String }
];
...
class SignatureProps {
    static getDefault() {
        ...
        props.text = "";
        const f = _groupdocs_examples_angular_common_components__WEBPACK_IMPORTED_MODULE_0__["Formatting"].default();
...
class SignatureTabActivatorService extends _groupdocs_examples_angular_common_components__WEBPACK_IMPORTED_MODULE_0__["TabActivatorService"] {
    constructor() {
        super();
    }
}
...
let SignatureTabComponent = class SignatureTabComponent {
...
/* harmony import */ var _fortawesome_angular_fontawesome__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @fortawesome/angular-fontawesome */ "../../libs/signature/node_modules/@fortawesome/angular-fontawesome/fesm2015/angular-fontawesome.js");
...
let SignatureService = class SignatureService {
    ...
    loadSignatureImage(sign) {
        return this._http.post(this._config.getSignatureApiEndpoint() + _groupdocs_examples_angular_common_components__WEBPACK_IMPORTED_MODULE_3__["Api"].LOAD_SIGNATURE_IMAGE, {
            ...
            'password': ''
        }, _groupdocs_examples_angular_common_components__WEBPACK_IMPORTED_MODULE_3__["Api"].httpOptionsJson).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((props) => {
    ...
    sign(credentials, signatures) {
        const docType = _groupdocs_examples_angular_common_components__WEBPACK_IMPORTED_MODULE_3__["FileUtil"].find(credentials.guid, false).format;
...
const $ = jquery__WEBPACK_IMPORTED_MODULE_7__;
let Signature = class Signature {
    constructor(_signatureService, _removeSignatureService, _copySignatureService, _activeSignatureService, _signaturesHolderService) {
        ...
        this._activeSignatureService.activeChange.subscribe((id) => {
            if (this.id === id) {
                this.active = true;
            }
            else {
        ...
        this.subject.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_11__["debounceTime"])(300)).subscribe(text => {
            this.sendSaveText();
        });
    }
    ngOnInit() {
    ...
    getFormatting() {
        ...
        const formatting = _groupdocs_examples_angular_common_components__WEBPACK_IMPORTED_MODULE_3__["Formatting"].default();
        if (f) {
    ...
    remove() {
        const del = new _signature_models__WEBPACK_IMPORTED_MODULE_2__["RemoveSign"]();
    ...
    notifyChanges() {
        const changes = new _signature_models__WEBPACK_IMPORTED_MODULE_2__["CopyChanges"]();
    ...
    onCopySign() {
        const copy = new _signature_models__WEBPACK_IMPORTED_MODULE_2__["CopySign"]();
    ...
    sendSaveText() {
        this._signatureService.saveTextSignature(this.data).subscribe((p) => {
            if (_signature_models__WEBPACK_IMPORTED_MODULE_2__["DraggableSignature"].TEMP === this.data.guid) {
    ...
    getMenuShift() {
        const menuWidth = this.type === _signature_models__WEBPACK_IMPORTED_MODULE_2__["SignatureType"].TEXT.id ? 616 : 228;
...
/* harmony import */ var _signature_models__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./signature-models */ "../../libs/signature/src/lib/signature-models.ts");
...
class SignaturesHolderService {
    ...
    changeTemp(imageGuid, id) {
        this.remove(_signature_models__WEBPACK_IMPORTED_MODULE_0__["DraggableSignature"].TEMP, id);
...
let StampCanvasComponent = class StampCanvasComponent {
    constructor(_activeCanvasService, _removeCanvas, _onCloseService) {
        ...
        this._activeCanvasService.activeChange.subscribe((id) => {
            if (this.id === id) {
                this.active = true;
            }
            else {
...
/* harmony import */ var _groupdocs_examples_angular_common_components__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @groupdocs.examples.angular/common-components */ "../../dist/libs/common-components/fesm2015/groupdocs.examples.angular-common-components.js");
...
const $ = jquery__WEBPACK_IMPORTED_MODULE_9__;
let StampModalComponent = class StampModalComponent {
    constructor(_addDynamicComponentService, _activeCanvasService, _windowService, _removeCanvas, _signatureService, _tabActivationService, _modalService) {
        ...
        this._removeCanvas.removeCanvas.subscribe((id) => {
    ...
    saveSign() {
        ...
        this._signatureService.saveStamp(img, props).subscribe(() => {
            this._tabActivationService.changeActiveTab(_signature_models__WEBPACK_IMPORTED_MODULE_2__["SignatureType"].STAMP.id);
        });
        this.close();
    }
    close() {
    ...
    onCloseOpen($event) {
        if ($event) {
            this.textString = '';
            const props = new _signature_models__WEBPACK_IMPORTED_MODULE_2__["StampCanvasProps"]().init(this.isMobile);
    ...
    addCircle(props, theFirst) {
        if (this.dynamicDirective) {
            ...
            const stampCircle = this._addDynamicComponentService.addDynamicComponent(viewContainerRef, _stamp_canvas_stamp_canvas_component__WEBPACK_IMPORTED_MODULE_7__["StampCanvasComponent"]);
    ...
    addCanvas() {
        const props = new _signature_models__WEBPACK_IMPORTED_MODULE_2__["StampCanvasProps"]();
...
const $ = jquery__WEBPACK_IMPORTED_MODULE_3__;
let TextMenuComponent = class TextMenuComponent {
    constructor(_onCloseService) {
        this._onCloseService = _onCloseService;
...
let UploadSignatureComponent = class UploadSignatureComponent {
    constructor(_signatureService) {
        this._signatureService = _signatureService;
        this.closePanel = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
    }
    ...
    addFiles(files) {
        const data = new _signature_models__WEBPACK_IMPORTED_MODULE_2__["FileListWithParams"](files, this.signatureType);
    ...
    constructor(_viewerService, _modalService, configService, uploadFilesService, _navigateService, _zoomService, pagePreloadService, _renderPrintService, passwordService, _windowService, _loadingMaskService) {
        ...
        uploadFilesService.uploadsChange.subscribe((uploads) => {
            if (uploads) {
                let i;
                for (i = 0; i < uploads.length; i++) {
                    this._viewerService.upload(uploads.item(i), '', this.viewerConfig.rewrite).subscribe((obj) => {
                        this.fileWasDropped ? this.selectFile(obj.guid, '', '') : this.selectDir('');
                    });
                }
            }
...
/* harmony import */ var _fortawesome_angular_fontawesome__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @fortawesome/angular-fontawesome */ "../../libs/viewer/node_modules/@fortawesome/angular-fontawesome/fesm2015/angular-fontawesome.js");
