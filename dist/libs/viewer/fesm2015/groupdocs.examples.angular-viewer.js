...
import { HttpClient, HttpErrorResponse, HttpClientModule, HTTP_INTERCEPTORS } from '@angular/common/http';
import { Api, ConfigService, CommonModals, FileUtil, ModalService, UploadFilesService, NavigateService, ZoomService, PagePreloadService, RenderPrintService, PasswordService, WindowService, LoadingMaskService, DocumentComponent, ErrorInterceptorService, ExceptionMessageService, LoadingMaskInterceptorService, CommonComponentsModule } from '@groupdocs.examples.angular/common-components';
 ...
 * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class ViewerErrorInterceptorService extends ErrorInterceptorService {
    /**
...
/** @nocollapse */ ViewerErrorInterceptorService.ngInjectableDef = ɵɵdefineInjectable({ factory: function ViewerErrorInterceptorService_Factory() { return new ViewerErrorInterceptorService(ɵɵinject(ModalService), ɵɵinject(ExceptionMessageService)); }, token: ViewerErrorInterceptorService, providedIn: "root" });
if (false) {
    /**
     * @type {?}
     * @private
...
class ErrorReportModalComponent {
    /**
...
export { ViewerAppComponent, ViewerConfigService, ViewerModule, ViewerService, endPoint, initializeApp, setupLoadingInterceptor, ThumbnailsComponent as ɵa, RunPresentationComponent as ɵb, ExcelDocumentComponent as ɵc, ExcelPageComponent as ɵd, ExcelPageService as ɵe, ErrorReportModalComponent as ɵf, ViewerErrorInterceptorService as ɵg };
