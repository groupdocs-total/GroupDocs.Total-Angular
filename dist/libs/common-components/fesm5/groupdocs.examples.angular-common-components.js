    ...
    function () {
        ...
        if (el) {
            ...
            if (currentEl) {
                ...
                var options = {
                    left: 0,
                    top: ($$4(currentEl).offset().top * 1) + el.parentElement.parentElement.scrollTop - 150,
                };
                // using polyfill
