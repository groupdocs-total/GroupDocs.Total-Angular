(function (global, factory) {
    ...
    (global = global || self, factory((global.groupdocs = global.groupdocs || {}, global.groupdocs.examples = global.groupdocs.examples || {}, global.groupdocs.examples.angular = global.groupdocs.examples.angular || {}, global.groupdocs.examples.angular.editor = {}), global.ng.platformBrowser, global.ng.core, global.ng.common.http, global.commonComponents, global.rxjs, global.jquery, global.angularFontawesome, global.fontawesomeSvgCore, global.freeSolidSvgIcons, global.freeRegularSvgIcons, global.core$1));
}(this, (function (exports, platformBrowser, core, http, commonComponents, rxjs, jquery, angularFontawesome, fontawesomeSvgCore, freeSolidSvgIcons, freeRegularSvgIcons, core$1) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var EditorAppComponent = /** @class */ (function () {
            ...
            function (text) {
                if (_this.file && _this.file.pages) {
                    ...
                    if (_this.ifPresentation()) {
                        _this.pagesData.set(_this.selectedPageNumber - 1, text);
                    }
                }
            }));
        }
         ...
         * @return {?}
         */
        EditorAppComponent.prototype.ifPresentation = /**
         * @return {?}
         */
        function () {
         ...
         * @return {?}
         */
        EditorAppComponent.prototype.selectCurrentPage = /**
         * @param {?} pageNumber
         * @return {?}
         */
        function (pageNumber) {
        ...
        function (file) {
            ...
            if (this.file && this.file.pages[0]) {
                ...
                function (page) {
                    page.editable = true;
                    if (page.width === 0)
                        page.width = _this.ifPresentation() ? 960 : 595;
                    if (page.height === 0)
                        page.height = _this.ifPresentation() ? 540 : 842;
                }));
        ...
        function (credentials) {
            ...
            /** @type {?} */
            var saveFile = new commonComponents.SaveFile(credentials.guid, credentials.password, this.textBackup, this.selectedPageNumber - 1);
        ...
        function (credentials) {
            ...
            this.textBackup = this.getPageWithRootTags(this.textBackup, credentials.guid);
            /** @type {?} */
            var saveFile = new commonComponents.SaveFile(credentials.guid, credentials.password, this.textBackup, 0);
