import { Injectable, ɵɵdefineInjectable, ɵɵinject, Component, Input, Output, EventEmitter, ElementRef, Directive, HostListener, ViewChild, NgModule, APP_INITIALIZER } from '@angular/core';
...
var SignatureAppComponent = /** @class */ (function () {
    ...
    function () {
        ...
        var signatures = [];
        try {
            for (var _b = __values(this._signaturesHolderService.values()), _c = _b.next(); !_c.done; _c = _b.next()) {
                var ids = _c.value;
                /** @type {?} */
                var id = ids.pop();
                /** @type {?} */
